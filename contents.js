        ...
        <div className="row">
          <div className="col-3 ">
            <ul className="list-group position-fixed">
              <li key={11} className="list-group-item active" onClick={()=>{this.handleClick("All Categories")}}>
                All Categories
              </li>
              {this.state.categories.map((category) => (
                <li onClick={()=>{this.handleClick(category['categoryname'])}}
                  key={category["categoryname"]} className="list-group-item">
